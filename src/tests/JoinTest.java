...
class JoinsDriver implements GlobalConst {
  ...
  private void Query8_CondExpr(CondExpr[] expr,String conditionalOperatorOne, String conditionalOperatorTwo) {
	    ...
	    */
	    ...
	    expr[1].operand1.symbol = new FldSpec (new RelSpec(RelSpec.outer),2); // Changed from 1 to 3 because want to compare the third one
  ...
  public void Query6()
	...
	public void Query7() {
		...
		// 1 is LE
		System.out
				.print("**********************TASK 2A strating *********************\n");
		boolean status = OK;
		
		System.out.println("Joining column1 with column1 with self join with less than equal to");
		...
		try {
			...
			ie = new IESelfJoinSinglePredicate(Stypes, 4, Ssizes, Rtypes, 4, Rsizes, 1, 10,
	...
	public void Query8() {
		...
		String conditionalOperatorOne = "2";
		String conditionalOperatorTwo = "2";
		...
		Query8_CondExpr(outFilter,conditionalOperatorOne,conditionalOperatorTwo);
		...
		DBBuilder builder = new DBBuilder();
		try {
			am = new FileScan("R.in", Q1Types, Ssizes, (short) 4,
					(short) 4, Q1Projection, null);
		} catch (Exception e) {
			status = FAIL;
			System.err.println("" + e);
		}
		...
		FileScan am2 = null;
		try {
			am2 = new FileScan("R.in", Q2Types, Rsizes, (short) 4,
		...
		FileScan am3 = null;
		try {
			am3 = new FileScan("R.in", Q3Types, Q3sizes, (short) 4,
		...
		FileScan am4 = null;
		try {
			am4 = new FileScan("R.in", Q4Types, Q4sizes, (short) 4,
					(short) 4, Q4Projection, null);
		} catch (Exception e) {
			status = FAIL;
			System.err.println("" + e);
		}
		...
		if(conditionalOperatorOne.equalsIgnoreCase("2") || conditionalOperatorOne.equalsIgnoreCase("3")){
			if(conditionalOperatorTwo.equalsIgnoreCase("2") || conditionalOperatorTwo.equalsIgnoreCase("3")){
				eqOff = 0;
			}
		...
		try {
			...
			ie = new IESelfJoinTwoPredicate(Q1Types, 4, Ssizes, Q2Types, 4, Rsizes, 1/*Join condition column*/, 10,
					2/*Join condition column*/, 10, 10, am, am2, false, false, tupleOrderFor1, tupleOrderFor2, outFilter,
					proj_list, 4/* number of output fields*/,eqOff);
		} catch (Exception e) {
			System.err.println("*** join error in SortMerge constructor ***");
			status = FAIL;
			System.err.println("" + e);
